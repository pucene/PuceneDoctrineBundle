...
namespace Pucene\Bundle\DoctrineBundle\DependencyInjection\CompilerPass;
...
{
    const TAG_NAME = 'pucene_doctrine.query_builder';
    const POOL_SERVICE_ID = 'pucene_doctrine.query_builder.pool';
